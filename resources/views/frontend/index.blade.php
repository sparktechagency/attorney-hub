...
@section('content')
    ...
    <div class="slider_area ">
        <div class="slider_area_inner d-flex align-items-center" style="background-image: url(img/banner/banner.png);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                    ...
                    <div class="col-xl-12">
                        <div class="testmonial_active owl-carousel">
                            <div class="single_testmonial text-center">
                                ...
                                <p>Family law is where the heart meets the courtroom </p>
                            ...
                            <div class="single_testmonial text-center">
                                {{-- <i class="flaticon-straight-quotes"></i> --}}
                                <p>Education law ensures that the classroom <br>door is open to every child, regardless of zip code </p>
                                {{-- <div class="author_info d-flex justify-content-center align-items-center">
                                    <div class="thumb">
                                        <img src="img/testmonial/smaill_thumb.png" alt="">
                                    </div>
                            ...
                            <div class="single_testmonial text-center">
                                {{-- <i class="flaticon-straight-quotes"></i> --}}
                                <p>Finance is the art of passing money from hand to hand until it finally disappears. </p>
                                {{-- <div class="author_info d-flex justify-content-center align-items-center">
                                    <div class="thumb">
                                        <img src="img/testmonial/smaill_thumb.png" alt="">
                                    </div>
                            ...
                            <div class="single_testmonial text-center">
                                {{-- <i class="flaticon-straight-quotes"></i> --}}
                                <p>Corporate law is not about right or wrong; it's about what's <br> legally permissible and strategically sound.</p>
                                {{-- <div class="author_info d-flex justify-content-center align-items-center">
                                    <div class="thumb">
                                        <img src="img/testmonial/smaill_thumb.png" alt="">
                                    </div>
